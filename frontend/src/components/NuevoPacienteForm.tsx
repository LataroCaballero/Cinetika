  ...
  <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '85vh' }}>
    <div className="basic-container p-4 rounded">
        <form onSubmit={handleSubmit(enviar)}>
            <div className="mb-5">
                <label>Nombre</label>
                <input type="text" className="form-control w-100" autoComplete="off" placeholder="Juan" {...register("nombre")}/>
                <label>Apellido</label>
                <input type="text" className="form-control w-100" autoComplete="off" placeholder="Perez" {...register("apellido")}/>
                <label>Dni</label>
                <input type="text" className="form-control w-100" autoComplete="off" placeholder="Juan" {...register("dni")}/>
            </div>
            <div className="row">
